...
func (p *Postgres) Migrate(ctx context.Context) error {
	if _, err := p.pool.Exec(ctx, migrations.InitSQL+"\n"+migrations.ProviderContentSQL+"\n"+migrations.GuoraiSQL+"\n"+migrations.XHSJGCampaignsSQL+"\n"+migrations.XHSJGDeliverySQL+"\n"+migrations.XHSJGManualSyncSQL+"\n"+migrations.MaituoCustomerDailySQL+"\n"+migrations.MaituoNoteReportDatesSQL+"\n"+migrations.MaituoPartialWorkbooksSQL+"\n"+migrations.MaituoDatedSummaryTablesSQL+"\n"+migrations.MaituoRemoveImportVersionSQL+"\n"+migrations.SimilarNoteEmbeddingsSQL+"\n"+migrations.GuoraiCredentialsSQL+"\n"+migrations.DandelionExcelHistorySQL+"\n"+migrations.ManuscriptAssetsSQL+"\n"+migrations.MaituoSearchUserOverlapSQL+"\n"+migrations.ReferenceNoteIDsSQL+"\n"+migrations.ReferenceMaterialContentsSQL+"\n"+migrations.ProviderNoteSourceTitleSQL+"\n"+migrations.CoenzymeQ10DailySQL+"\n"+migrations.SelfServeDeliverySQL+"\n"+migrations.ManualMaterialsSQL+"\n"+migrations.ManualMaterialNotesSQL+"\n"+migrations.MaituoNotePlacementSQL+"\n"+migrations.MaituoEstimatedPostbackCostSQL+"\n"+migrations.MaituoNoteSubaccountsSQL); err != nil {
